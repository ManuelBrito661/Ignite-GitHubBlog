  ...
  return (
    <div className="bg-base-background antialiased">
      <div className="flex justify-center">
        ...
        {/* Profile */}
        <div className="w-[54rem] bg-base-post h-48 flex items-center justify-between rounded-md mt-[-5rem] ">
          ...
          <div className="px-8">
            <div className="flex items-center justify-between ">
              ...
              <a href="https://github/ManuelBrito661" className="flex items-center gap-[0.475rem] text-blue font-bold text-sm border-b-2 border-transparent hover:border-b-2 hover:border-blue transition-all">
